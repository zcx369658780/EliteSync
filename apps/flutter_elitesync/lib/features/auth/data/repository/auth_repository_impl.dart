...
import 'package:flutter_elitesync/features/auth/data/dto/login_request_dto.dart';
import 'package:flutter_elitesync/features/auth/data/dto/register_request_dto.dart';
...
class AuthRepositoryImpl implements AuthRepository {
  ...
  Future<void> register({
    ...
    return _remote.register(
      RegisterRequestDto(phone: phone, password: password, nickname: nickname),
    );
  }
