...
return [
    'android' => [
        'latest_version_name' => env('ANDROID_LATEST_VERSION_NAME', '0.02.01'),
        'latest_version_code' => (int) env('ANDROID_LATEST_VERSION_CODE', 201),
        'min_supported_version_name' => env('ANDROID_MIN_SUPPORTED_VERSION_NAME', '0.01.01'),
        'download_url' => env('ANDROID_DOWNLOAD_URL', 'https://slowdate.top/downloads/elitesync-0.02.01.apk'),
        'changelog' => env('ANDROID_CHANGELOG', '完成 UI 架构重构与 Flutter-Android 深度合并，核心页面全链路可用。'),
