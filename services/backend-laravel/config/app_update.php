...
return [
    'android' => [
        'latest_version_name' => env('ANDROID_LATEST_VERSION_NAME', '0.02.04'),
        'latest_version_code' => (int) env('ANDROID_LATEST_VERSION_CODE', 204),
        'min_supported_version_name' => env('ANDROID_MIN_SUPPORTED_VERSION_NAME', '0.01.01'),
        'download_url' => env('ANDROID_DOWNLOAD_URL', 'https://slowdate.top/downloads/elitesync-0.02.04.apk'),
        'changelog' => env('ANDROID_CHANGELOG', '更新版本号至 0.02.04，并重写发布记录与更新说明以对齐当前总基线文档；同步修复版本检查、下载地址与阿里云发布元数据。'),
