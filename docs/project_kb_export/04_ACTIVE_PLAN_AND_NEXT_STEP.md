...
- 如果继续按当前产品线推进，优先级应为：
  1. 验收 5.6+ 新整体开发计划与路线图
  2. 制定 `docs/version_plans/v_5_6_玄学能力二次产品化边界与校准版_开发计划书_2026_05_11.md`
...
- 继续做新版本前，先确认 5.6+ 两份主入口文件已通过顾问验收。
- 下一步只制定 5.6 具体开发计划书，不直接做 5.7 Match runtime。
